...
namespace WEV.WhiteRoom
{
    public class WorldSceneManager : MonoBehaviour
    {
        ...
        public WorldLocationData currentLocation;
        ...
        public void CheckForRequiredRenderers()
        {
            ...
            WorldLocationSceneSet location = PlayerUIManager.instance.player.areaCurrentlyIn;
        ...
        private IEnumerator CheckForRequiredSceneRenderersCoroutine(WorldLocationSceneSet location)
        {
            ...
            for (int i = 0; i < WorldLocationManager.instance.worldLocationRenderers.Count; i++)
            {
                ...
                if (sceneBuildIndexes.Contains(
                        WorldLocationManager.instance.worldLocationRenderers[i].renderSceneID))
                {
                    WorldLocationManager.instance.worldLocationRenderers[i]
